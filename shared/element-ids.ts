...
export const MODEL_GATEWAY_PICKER_ID = 'model-gateway-picker' as const;
export const MODEL_GATEWAY_PICKER_OPTION_ITEM_ID = 'model-gateway-picker-option-item' as const;
export const MODEL_GATEWAY_PICKER_ERROR_ID = 'model-gateway-picker-error' as const;
export const MODEL_GATEWAY_PICKER_RETRY_BUTTON_ID = 'model-gateway-picker-retry-button' as const;
